...
namespace test2
{
    public class plan : GH_Component
    {
        /// <summary>
        ...
        public plan()
          : base("Plan", "Plan",
              "Create the design plan based on the information of member.",
              "ParaParaRESP", "SettingCondition")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddTextParameter("Discription", "Discription", "Input the discription.", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            DA.GetData("Discription", ref discription);
            string method = "";
            string name = "Mark";
            string value = "";
