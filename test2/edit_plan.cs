...
namespace test2
{
    public class edit_plan : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the edit_plan class.
        /// </summary>
        public edit_plan()
          : base("EditMember", "EditMember",
              "Edit the existing brace based on the information.",
              "ParaParaRESP", "1.Plan")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddGenericParameter("HowtoChange", "HowtoChange", "Input the sign how to change the damper design", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            DA.GetData("HowtoChange", ref value);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return test2.Properties.Resources.edit;
            }
        }
        ...
        {
            get { return new Guid("1668f95b-7e27-4981-aea5-e8c820434e60"); }
        }
    }
}